...
def download_fashion_mnist(save_to, force=False):
...
def download_and_uncompress_zip(URL, dataset_dir, force=False):
    ...
    :param URL: the download links for data
    :param dataset_dir: the path to save data
    :param force: re-download data
    """
...
if __name__ == '__main__':
    download_fashion_mnist(save_to='data/fashion-mnist')
