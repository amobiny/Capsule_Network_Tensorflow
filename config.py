...
parser.add_argument('--save_dir', default='./saved_model/', help='path for saving the models')
...
parser.add_argument('--test_freq', default=500, help='The frequency of saving test results (step)')
